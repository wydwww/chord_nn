...
file_name = "c4.wav"    
music = AudioSegment.from_wav('/Users/intel/music-real/'+file_name)
chunks = split_on_silence(music,200,-20)

# Split the sample to 100 segments.
for i, chunk in enumerate(chunks):
    chunk.export('/Users/intel/d4testfiles/'+file_name[:-4]+'-{0}.wav'.format('%.2d' % i), format="wav")
